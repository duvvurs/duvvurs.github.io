...
**FinOps & Governance:** Azure Cost Management & Billing · Budgeting, Forecasting & Anomaly Detection · Reserved Instances & Azure Savings Plans · Showback / Chargeback / Allocation · Tagging Governance & Azure Policy · Unit Economics & Cost per Workload · FinOps Lifecycle (Inform → Optimize → Operate) · EA / MCA / CSP Licensing Constructs · GreenOps & Carbon Optimization
...
### Infosys Limited — Senior FinOps Engineer & Cloud Consultant
**July 2018 – Present | India / Client-site Europe**

**European Insurance Client — Cloud Financial Governance**
- Governed Azure cloud spend for a European insurance organisation, establishing FinOps practices across multi-subscription environments with significant annual cloud spend under management
...
- Redesigned Azure architecture and governance policies, optimising cloud footprint to deliver £52K/month (£624K annualised) in cost savings
- Implemented chargeback mechanisms attributing costs to individual projects, driving cost accountability across engineering teams
- Conducted cloud infrastructure assessment, identifying and eliminating over-provisioned, idle, and orphaned resources through policy optimisation and resource rightsizing
- Aligned solution design with cost-efficient architecture patterns, ensuring new workloads were provisioned with optimal pricing models from inception

**Cross-Client FinOps Operations (3,000+ Resources)**
- Led day-to-day cloud operations across multiple international clients, governing 3,000+ Azure infrastructure resources
- Managed Azure Policy, RBAC, and Management Groups ensuring governance compliance across multi-subscription environments
- Supported cloud migration projects, designing cost-efficient target architectures and recommending optimal pricing models for migrated workloads
- Partnered with engineering, finance, and leadership teams to align cloud investment with business objectives through regular cost review cadences

### PALS Global Solutions / Microsoft India — Cloud Infrastructure Consultant & Azure Technical Specialist
**March 2013 – July 2018 | India**

**Microsoft India — External Cloud Technical Consultant (2016–2019)**
- Seconded to Microsoft India as external consultant through PALS partnership, demonstrating Azure capabilities and guiding SME customers through cloud adoption
- Developed deep understanding of Azure pricing models, EA/MCA licensing, and commercial constructs from the vendor side — insight that now informs every cost optimisation decision
- Presented interactive Power BI dashboards for cost visibility, enabling customers to visualise and plan cloud investments before migration
- Advised customers on budgeting strategies, right-sizing resource selection, and commitment model options to prevent over-provisioning from day one
- Enabled Azure DevOps practices and PaaS adoption, helping customers reduce infrastructure costs through modern service models

**PALS Global Solutions — Cloud Infrastructure & Data Engineering**
...
- **FinOps Certified Practitioner** — FinOps Foundation (In Progress, Est. Q3 2026)
- **Microsoft Certified: Azure Administrator** — Microsoft
- **Implementing Microsoft Azure Infrastructure Solutions** — Microsoft Specialist
...
**Bachelor of Engineering, Computer Science & Engineering** — Anna University, Chennai, India (2011)
